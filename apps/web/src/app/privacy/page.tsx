        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-sm max-w-none space-y-6">
            <p className="text-muted-foreground">
              FutureClock株式会社（以下「当社」）は、本ウェブサイト上で提供するサービス（以下「本サービス」）における
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                クレジットカード番号などの個人情報をお尋ねすることがあります。
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
                ...
                <li>ユーザーが利用中のサービスの新機能、更新情報等をお知らせするため</li>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                当社に対して個人情報の訂正、追加または削除（以下「訂正等」）を請求することができます。
              </p>
            </section>

            <section>
              <h2 className="text-xl font-semibold mb-4">第8条（プライバシーポリシーの変更）</h2>
              <p className="text-muted-foreground">
            ...
            <section>
              <h2 className="text-xl font-semibold mb-4">第9条（お問い合わせ窓口）</h2>
              <p className="text-muted-foreground">
                本ポリシーに関するお問い合わせは、下記の窓口までお願いいたします。
              </p>
              <div className="mt-4 p-4 bg-muted rounded-lg text-sm">
                <p>FutureClock株式会社</p>
                <p>メールアドレス: privacy@futureclock.co.jp</p>
              </div>
            </section>
